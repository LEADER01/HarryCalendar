...
abstract class BasePresenter extends Nette\Application\UI\Presenter
{
	...
	public function beforeRender()
	{
		...
		$bgTable = new Model\BackgroundTable($this->database, $this->getUser());
		$this->template->currentYearTable = $bgTable->createTable("currentYear", array("random" => !$this->getUser()->isLoggedIn(), "showToday" => true));
//		$this->template->previousYearsTable = Model\BackgroundTable::createTable("previousYears", array("year" => "1997"));
		$this->template->previousYearsTable = $bgTable->createTable("previousYears", "1997");
	}
